...
final class ModeloDatos: ObservableObject{
    @Published var arrAmigos: [Amigo] = [
        Amigo(id: UUID().uuidString, nombre: "Lionel Messi", telefono: "655-555-555", email: "leomessi@gmail.com",
                           about: "Soy Lionel Messi", imagenID: "messi",
                           latitud: 36.8304668189410, longitud:  -2.4060252816326977,
                           favorito: true,
                           mensajes: [
                            Mensaje(date: Date(), texto: "Hola, ¿como vas?", contestacion: false),
                            Mensaje(date: Date(), texto: "Adios", contestacion: true)
                           ]),
        Amigo(id: UUID().uuidString, nombre: "Luis Suarez", telefono: "602-80-80-80", email: "lsuarez@gmail.com",
              about: "Soy el mejor amigo de Lionel Messi", imagenID: "suarez",
              latitud: 36.8389157611977, longitud: -2.40714076462062,
              favorito: true,
              mensajes: [
                Mensaje(date: Date(), texto: "Hola y adios", contestacion: true),
              ]),
        Amigo(id: UUID().uuidString, nombre: "Neymar Junior", telefono: "602-50-50-50", email: "neymar@gmail.com",
        ...
        Amigo(id: UUID().uuidString, nombre: "Cristiano Ronaldo", telefono: "602-42-81-82", email: "cr7@gmail.com",
